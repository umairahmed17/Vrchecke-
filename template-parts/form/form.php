...
<article class="vrchecke-form"
    ...
    <form action="">
        <section class="form-sections" data-section="1">
            ...
            <div class="e-statement-container vrchecke-input-container vrchecke-input-container--image">
                <div class="icon-container icon-container--lg">
                    <?php if ( get_theme_mod( 'option_first_image_section_one' ) ) {?>
                    <img src="<?php echo esc_url( get_theme_mod( 'option_first_image_section_one' ) ) ?>" />
                    <?php } else {?>
                ...
                <div class="vrchecke-radio-container">
                    <div class="vrchecke-radio-wrapper">
                        <span class="vrchecke-radio vrchecke-radio--hidden"><?php _e( 'Select', 'wp-rig' );?></span>
                        <span class="vrchecke-radio">Y</span>
                    </div>
                </div>
                <label for="check-yes">
                    <input type="radio" id="check-yes" name="e-statement-check" value="true" />
                    <?php _e( get_theme_mod( 'option_first_section_one', 'Yes' ), 'wp-rig' );?>
                </label>
            ...
            <div class="e-statement-container vrchecke-input-container vrchecke-input-container--image">
                <div class="icon-container icon-container--lg">
                    <?php if ( get_theme_mod( 'option_second_image_section_first' ) ) {?>
                    <img src="<?php echo esc_url( get_theme_mod( 'option_second_image_section_first' ) ) ?>" />
                    <?php } else {?>
                    <span class="material-icons">done</span>
                    <?php }?>
                </div>
                ...
                <label for="check-no">
                    ...
                    <?php _e( get_theme_mod( 'option_second_section_one', 'No' ), 'wp-rig' );?>
                </label>
                <div class="icon-container"><span class="material-icons">
                        done
                    </span></div>
        ...
        <section class="form-sections" data-section="2">
            ...
            <input id="num_devices" name="number_of_devices" type="number" inputmode="numeric"
                placeholder="<?php _e( get_theme_mod( 'placeholder_first_section_two', 'Number of Electrical Devices' ), 'vrchecke' );?>">
        ...
        <section class="form-sections  form-sections--image" data-section="3">
            ...
            <div class="electrical-eqp-container vrchecke-input-container vrchecke-input-container--image"
                ...
                <label for="check-p">
                    <input type="checkbox" id="check-p" name="electrical_eqp[]"
            ...
            <div class="electrical-eqp-container vrchecke-input-container vrchecke-input-container--image"
                ...
                <label for="check-s">
                    <input type="checkbox" id="check-s" name="electrical_eqp[]"
            ...
            <div class="electrical-eqp-container vrchecke-input-container vrchecke-input-container--image"
                ...
                <label for="check-es">
                    <input type="checkbox" id="check-es" name="electrical_eqp[]"
            ...
            <div class="electrical-eqp-container vrchecke-input-container vrchecke-input-container--image"
                ...
                <label for="check-em">
                    <input type="checkbox" id="check-em" name="electrical_eqp[]"
            ...
            <div class="electrical-eqp-container vrchecke-input-container vrchecke-input-container--image"
                ...
                <label for="check-m">
                    <input type="checkbox" id="check-m" name="electrical_eqp[]"
        ...
        <section class="form-sections" data-section="4">
            ...
            <div class="input-container">
                ...
                <input id="zip" name="postal-code" type="text" inputmode="numeric"
                    ...
                    placeholder="<?php _e( get_theme_mod( 'placeholder_first_section_four', 'Zip Code' ), 'vrchecke' );?>">
            </div>
        </section>
        ...
        <section class="form-sections" data-section="6">
            ...
            <p class="name-container input-container__ls">
                <input type="text"
                    placeholder="<?php _e( get_theme_mod( 'placeholder_first_section_five', 'First Name' ), 'vrchecke' );?>"
                    name="first-name" />
                <input type="text"
                    placeholder="<?php _e( get_theme_mod( 'placeholder_second_section_five', 'Last Name' ), 'vrchecke' );?>"
                    name="last-name" />
            </p>
            <p class="street-container input-container__ls">
                <input type="text"
                    placeholder="<?php _e( get_theme_mod( 'placeholder_third_section_five', 'Street , House Number' ), 'vrchecke' );?>"
                    name="street-address" />
            </p>
            <p class="city-container input-container__ls">
                <input id="zip-duplicate" name="postal-code-duplicate" type="text" inputmode="numeric" readonly
                    placeholder="<?php _e( get_theme_mod( 'placeholder_first_section_four', 'Zip Code' ), 'vrchecke' );?>">
                <input type="text" placeholder="City" name="city" />
            </p>
            <p class="email-container input-container__ls">
                <input type="text"
                    placeholder="<?php _e( get_theme_mod( 'placeholder_fourth_section_five', 'Email Address' ), 'vrchecke' );?>"
                    name="email" />
                <input type="number"
                    placeholder="<?php _e( get_theme_mod( 'placeholder_fifth_section_five', 'Phone Number' ), 'vrchecke' );?>"
                    name="phone-number" />
            </p>
        </section>
