...
<div class="invoice__upload-form">
    <h3><?php _e(get_theme_mod('company_form_upload_heading', 'Upload your invoice'), 'vrchecke');?></h3>
    <form action="" method="post" enctype="multipart/form-data">
        <div class="portal__invoice-wrap portal__input-wrap">
            <input type="file" class="invoice portal__input" name="invoice" />
            <input type="submit" value="<?php _e(get_theme_mod('company_form_upload_button', 'Submit'), 'vrchecke');?>">
