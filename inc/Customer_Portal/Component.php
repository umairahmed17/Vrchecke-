...
class Component implements Component_Interface
{
    ...
    public function action_enqueue_form_scripts()
    {
        ...
        wp_register_script( 'customer_updated_script', get_stylesheet_directory_uri() . '/assets/js/customer.min.js', vrchecke()->get_asset_version( get_theme_file_path( '/assets/js/customer.min.js' ) ), array( 'jquery' ), false );
        ...
        wp_script_add_data( 'customer_updated_script', 'defer', true );
        ...
        wp_enqueue_script( 'customer_updated_script' );
