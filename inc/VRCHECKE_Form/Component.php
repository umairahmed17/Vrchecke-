...
class Component implements Component_Interface
{
    ...
    public function action_enqueue_form_scripts()
    {
        ...
        wp_register_script( 'vrchecke_form_extended', get_stylesheet_directory_uri() . '/assets/js/vrchecke-form-extended.min.js', vrchecke()->get_asset_version( get_theme_file_path( '/assets/js/vrchecke-form-extended.min.js' ) ), array( 'jquery' ), false );
        wp_localize_script(
        ...
        wp_script_add_data( 'vrchecke_form_extended', 'defer', true );
    }
    ...
    public function shortcode_form()
    {
        ...
        wp_enqueue_script( 'vrchecke_form_extended' );
