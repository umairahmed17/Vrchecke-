...
class Component implements Component_Interface
{
    ...
    public function action_customize_register( WP_Customize_Manager $wp_customize )
    {
        ...
        $wp_customize->add_setting( 'company_option_amount_symbol', array(
            'type'              => 'theme_mod',
            'transport'         => 'refresh',
            'sanitize_callback' => 'wp_filter_nohtml_kses',
            'default'           => '$',
        ) );
        $wp_customize->add_control( 'company_option_amount_symbol', array(
            'label'   => 'Currency',
            'section' => 'customer_customizer_section_currency',
            'type'    => 'text',
        ) );

        $wp_customize->add_setting( 'company_option_amount_symbol_position', array(
            'type'              => 'theme_mod',
            'transport'         => 'refresh',
            'sanitize_callback' => 'wp_filter_nohtml_kses',
            'default'           => 'After',
        ) );
        $wp_customize->add_control( 'company_option_amount_symbol_position', array(
            'label'   => 'Currency',
            'section' => 'customer_customizer_section_currency',
            'type'    => 'radio',
            'choices' => array(
